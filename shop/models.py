...
class NutritionalBenefit(models.Model):
    ...
    BENEFIT_CHOICES = [
        ...
        ('calcium', 'Calcium'),
        ('low_fat_diet', 'Low Fat Diet'),
        ('iron_zinc', 'Iron & Zinc'),
    ]
    
    name = models.CharField(max_length=50, choices=BENEFIT_CHOICES, unique=True)
    display_name = models.CharField(max_length=100)
    description = models.TextField(blank=True, null=True)
    is_active = models.BooleanField(default=True)
...
class Product(models.Model):
    ...
    nutritional_benefits = models.ManyToManyField(NutritionalBenefit, blank=True, related_name='products')
